...
class GolfHandicapCalculatorTest {
    ...
    void accuratelyDeterminesHandicap() {
        ...
        assertEquals(8.3, GolfHandicapCalculator.calculateHandicap(new int[]{85, 80, 76, 79, 82}, new int[]{72, 72, 72, 71, 71}));
    ...
    void correctlyRejectsIllegalParameters() {
        ...
        assertThrows(IllegalArgumentException.class, () -> GolfHandicapCalculator.calculateHandicap(new int[] {72}, new int[] {87, 88}));
